<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="update project_07_tourpackages set PackageImage=:pimage where PackageId=:imgid";
	...
	<body>
		<div class="page-container">
			<div class="left-content">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php" style="font-size: 16px; color: #25A0E6;" onmouseover="this.style.color='#87ceeb'" onmouseout="this.style.color='#25A0E6'"><strong>Inicio</strong></a><i class="fa fa-angle-right"></i>Renovar Imagen</li>
				</ol>
				<div class="grid-form">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									<?php 
										$imgid=intval($_GET['imgid']);
										$sql = "SELECT PackageImage from project_07_tourpackages where PackageId=:imgid";
										$query = $dbh -> prepare($sql);
										$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
										$query->execute();
									...
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Imagen Registrada:</label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="file" name="packageimage" id="packageimage" style="background-color: #cce6ff; border: 1px solid #99ccff; padding: 8px; border-radius: 5px; color: #333;" required>
										</div>
									</div>	
									<?php }} ?>
									<div class="row">
