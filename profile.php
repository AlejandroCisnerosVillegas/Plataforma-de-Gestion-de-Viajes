		...
		<div class="top-header">
			...
			<div class="privacy" style="display: flex; justify-content: center;  align-items: center;">
				<div class="container" style="text-align: center;">
					<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="margin-bottom: 20px; visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Perfil de Usuario</h3>
					<form name="chngpwd" method="post" style="max-width: 400px; margin: auto; text-align: left;">
						...
						<?php 
							...
							$sql = "SELECT * from project_07_users where EmailId=:useremail";
							$query = $dbh -> prepare($sql);
						...
						<p style="width: 400px;">
							<b>Fecha de la última modificación: </b>
						...
						<?php }} ?>
						<p style="width: 400px;">
							<button type="submit" name="submit6" class="btn-custom">Actualizar Perfil</button>
						</p>
					</form>
				</div>
			</div>
